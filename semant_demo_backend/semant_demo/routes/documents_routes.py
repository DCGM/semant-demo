...
@router.get("/api/v1/documents/browse", response_model=DocumentBrowseResponse, response_model_exclude_none=True)
...
@router.get("/api/v1/documents/{document_id}", response_model=DocumentResponse, response_model_exclude_none=True)
