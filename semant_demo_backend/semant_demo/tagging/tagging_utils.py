...
async def llm_tag_chunks(searcher:WeaviateAbstraction, tag_request: schemas.TaggingTaskReqTemplate) -> schemas.TagResponse:
        """
...
async def tag_chunks_with_llm_automatic(searcher: WeaviateAbstraction, tag_request: schemas.TaggingTaskReqTemplate) -> schemas.TagResponse:
        """
        Assigns automatic tags to chunks
        """
        try:
