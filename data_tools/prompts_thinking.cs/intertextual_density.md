...
Output example 1: {"reason": "Clear reasoning for the classification with evidence from the text.", "reason_cs": "The same reason translated from English to Czech language", "class": "no_references"}
Output example 2: {"reason": "Clear reasoning for the classification with evidence from the text.", "reason_cs": "The same reason translated from English to Czech language", "class": "dense"}
