...
- Output example 1: `{"reason": "Clear reasoning for the classification with evidence from the text.", "reason_cs": "The same reason translated from English to Czech language", "classes": ["procedurally_documented"]}`
- Output example 2: `{"reason": "Clear reasoning for the classification with evidence from the text.", "reason_cs": "The same reason translated from English to Czech language", "classes": ["source_attributed", "speculative_or_uncertain"]}`
