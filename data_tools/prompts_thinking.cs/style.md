...
- Output example 1: {"reason": "Clear reasoning for the classification with evidence from the text.", "reason_cs": "The same reason translated from English to Czech language.", "classes": ["neutral"]}
- Output example 2: {"reason": "Clear reasoning for the classification with evidence from the text.", "reason_cs": "The same reason translated from English to Czech language.", "classes": ["bureaucratic", "formulaic"]}
