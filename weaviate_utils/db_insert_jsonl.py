...
document_column_types = {
    ...
    "seriesName": wvc.DataType.TEXT,
    "seriesNumber": wvc.DataType.INT,
    "edition": wvc.DataType.TEXT,
    "manufacturePublisher": wvc.DataType.TEXT,
    "manufacturePlaceTerm": wvc.DataType.TEXT,
    "illustrators": wvc.DataType.TEXT_ARRAY,
    "translators": wvc.DataType.TEXT_ARRAY,
    "editors": wvc.DataType.TEXT_ARRAY,
    "redaktors": wvc.DataType.TEXT_ARRAY,
}
...
def main():
    ...
    if args.delete_old:
        ...
        try:
            ...
            client.collections.delete(args.tag_collection)
            client.collections.delete(args.usercollection_collection)
