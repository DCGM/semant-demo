...
```typescript
import type { DocumentDetailTextChunkWithUserCollectionInfo } from ''
...
const exampleParsed = JSON.parse(exampleJSON) as DocumentDetailTextChunkWithUserCollectionInfo
